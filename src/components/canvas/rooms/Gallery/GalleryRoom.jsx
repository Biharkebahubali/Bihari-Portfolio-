...
// ============================================
// 📁 FALLBACK PROJECTS — Vikram Laheri
// Used only if Sanity has no projects.
// ============================================
const FALLBACK_PROJECTS = [
    {
        id: 'portfolio',
        title: 'BIHAR KE BAHUBALI',
        ...
        description: 'Bihar Ke Bahubali is my flagship creative brand — a content platform showcasing coding tutorials, creative projects, and digital storytelling from Bihar. Built with modern React and scalable architecture to reach audiences across YouTube, Instagram, and Telegram.',
    ...
    },
    {
        ...
        description: 'Bihari Please Help Me is a Telegram bot that connects users directly with admins for real-time help and support. Built using the Telegram Bot API with custom webhooks and async message handling for reliable 24/7 delivery.',
        techStack: ['/textures/gallery/jslogo.webp', '/textures/gallery/phplogo.webp']
    },
    {
        id: 'community',
        ...
        description: 'A growing Telegram community where developers and creators discuss coding, share ideas, and support each other. Managed with automated moderation, scheduled content, and member engagement tools for a smooth community experience.',
    ...
    },
    {
        ...
        url: 'https://youtube.com/@bihar_ke_bahubali',
        description: 'My YouTube channel @bihar_ke_bahubali is an educational platform covering web development, creative coding, and 3D web experiences — all explained step-by-step in Hindi for the next generation of Indian developers.',
