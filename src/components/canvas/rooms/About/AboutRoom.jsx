...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'BIHAR KE BAHUBALI', subtitle: '< creative developer />' },
    { id: 'awards', position: [0, 0, -55], type: 'awards', title: 'ACHIEVEMENTS', subtitle: 'Content Creator • Developer • Artist' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: 'JOURNEY', subtitle: 'Self-Taught Developer from Bihar, India' },
