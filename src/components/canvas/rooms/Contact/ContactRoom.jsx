...
const ContactRoom = ({ showRoom, onReady, isExiting, isWarmup }) => {
    ...
    const handleMailSelect = () => {
        // Email redirect
        window.location.href = 'mailto:vikramkumarart@gmail.com';
    };
    ...
    return (
        <group ref={groupRef} position={[0, -0.7, -5]}>
            ...
            <SocialBarrel
                ...
                label="YOUTUBE"
                onClick={() => window.open('https://youtube.com/@bihar_ke_bahubali', '_blank')}
            ...
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="GITHUB"
                onClick={() => window.open('https://github.com/Biharkebahubali', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* TELEGRAM */}
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="TELEGRAM"
                onClick={() => window.open('https://t.me/+YPzfRgZy_6Y5NDQ1', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* INSTAGRAM - Main */}
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="INSTAGRAM"
                onClick={() => window.open('https://www.instagram.com/bihar_ke_bahubali/', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* INSTAGRAM - Personal */}
            <SocialBarrel
                position={isMobile ? [-0.5, 0.2, -8] : [-1.5, 0.2, -9]}
                rotation={[0, 0.1, 0]}
                texturePath="/textures/contact/beczka.webp"
                label="VIKRAM_LIFE_"
                onClick={() => window.open('https://www.instagram.com/vikram_life_/', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* MESSAGE (Triggers email) */}
            <SocialBarrel
